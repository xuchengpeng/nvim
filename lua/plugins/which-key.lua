...
function M.setup()
  ...
  which_key.add({
    ...
    { "<leader>bc", "<cmd>lua require('utils.buffer').close()<cr>", desc = "Close Buffer" },
    { "<leader>bn", "<cmd>lua require('utils.buffer').next()<cr>", desc = "Next Buffer" },
    { "<leader>bp", "<cmd>lua require('utils.buffer').prev()<cr>", desc = "Prev Buffer" },
    { "<leader>bs", "<cmd>lua require('utils.buffer').pick()<cr>", desc = "Switch Buffer" },
    { "<leader>c", group = "Coding" },
    { "<leader>ce", "<cmd>NvimTreeOpen<cr>", desc = "Explorer" },
    ...
    { "<leader>lf", "<cmd>lua require('plugins.lsp.format').format()<cr>", desc = "Format" },
    ...
    { "<leader>tb", "<cmd>lua require('plugins.toggleterm').toggle_term_cmd('btm')<cr>", desc = "Bottom" },
    { "<leader>td", "<cmd>lua require('plugins.toggleterm').toggle_term_cmd('gdu')<cr>", desc = "Disk Usage" },
    { "<leader>tg", "<cmd>lua require('plugins.toggleterm').toggle_term_cmd('glow')<cr>", desc = "Glow" },
    { "<leader>tl", "<cmd>lua require('plugins.toggleterm').toggle_term_cmd('lazygit')<cr>", desc = "Lazygit" },
    { "<leader>tp", "<cmd>lua require('plugins.toggleterm').toggle_term_cmd('python')<cr>", desc = "Python" },
    { "<leader>tt", "<cmd>ToggleTerm<cr>", desc = "Terminal" },
    { "<leader>u", group = "UI" },
    { "<leader>ua", "<cmd>lua require('utils.ui').toggle_autopairs()<cr>", desc = "Toggle Autopairs" },
    { "<leader>ub", "<cmd>lua require('utils.ui').toggle_background()<cr>", desc = "Toggle Background" },
    { "<leader>uc", "<cmd>lua require('utils.ui').set_colorscheme()<cr>", desc = "Set Colorscheme" },
    { "<leader>ui", "<cmd>lua require('utils.ui').set_indent()<cr>", desc = "Set Indent" },
    { "<leader>un", "<cmd>lua require('utils.ui').toggle_number()<cr>", desc = "Toggle Number" },
    { "<leader>us", "<cmd>lua require('utils.ui').toggle_statusline()<cr>", desc = "Toggle Statusline" },
    { "<leader>uw", "<cmd>lua require('utils.ui').toggle_wrap()<cr>", desc = "Toggle Wrap" },
